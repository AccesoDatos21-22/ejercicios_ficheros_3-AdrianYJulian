...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 100 ; i++) {
			...
			pk.escribirPokemon("./test.txt",tempPokemon.getName(), tempPokemon.getStat(Stat.Type.HP).getBaseStat(),tempPokemon.getStat(Stat.Type.ATTACK).getBaseStat(),tempPokemon.getStat(Stat.Type.DEFENSE).getBaseStat(),tempPokemon.getStat(Stat.Type.SPECIAL_ATTACK).getBaseStat(),tempPokemon.getStat(Stat.Type.SPECIAL_DEFENSE).getBaseStat(),tempPokemon.getStat(Stat.Type.SPEED).getBaseStat());
